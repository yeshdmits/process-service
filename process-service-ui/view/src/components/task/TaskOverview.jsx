...
export const Button = 'hover:cursor-pointer hover:bg-cyan-500 sticky bottom-2 w-full flex items-center justify-center min-h-14 mb-2 text-white mt-4 bg-cyan-600 border border-cyan-900';
